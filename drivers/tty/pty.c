 ...
 * has pty_bsd_ioctl.
 */
static struct tty_operations master_pty_ops_bsd = {
	.install = pty_install,
	.open = pty_open,
	.close = pty_close,
	.write = pty_write,
...
static struct tty_operations slave_pty_ops_bsd = {
	.install = pty_install,
	.open = pty_open,
	.close = pty_close,
	.write = pty_write,
...
static struct tty_operations ptm_unix98_ops = {
...
static struct tty_operations pty_unix98_ops = {
