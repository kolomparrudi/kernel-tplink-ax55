...
//#define printWar(fmt, args...) printk(KERN_CRIT "\033[4m[ %s ] %03d: "fmt"\033[0m", __FUNCTION__, __LINE__, ##args)
...
#ifdef CONFIG_TP_QCA_NSS_SAMEADDR_FIX
				skb->extra_flag |= (1<<1);
#endif
...
#ifdef CONFIG_TP_QCA_NSS_SAMEADDR_FIX
		skb->extra_flag |= (1<<1);
		//printk("send packet v6tunnel extra_flag trans to %d\n", skb->extra_flag);
#endif
