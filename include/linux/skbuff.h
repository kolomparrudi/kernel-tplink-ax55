...
#if defined(CONFIG_TP_IMAGE) || defined(CONFIG_TP_QCA_NSS_SAMEADDR_FIX)
	__u8			extra_flag;	/* bit 0 for guestnetwork br-filter, bit 1 for qca nss same addr check by tp */
#endif
